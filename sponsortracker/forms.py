...
class CurrentDealForm(flask_wtf.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.owner.choices = [("", "")] + [(user.user_auth.username, name_pattern.format(user=user)) for user in sorted_users if user.type in (data.UserType.SALES, data.UserType.EXEC)]
